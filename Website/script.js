// Neue Funktion zum Extrahieren von Parametern aus der URL
...
// Neue Funktion zum Anzeigen der extrahierten Parameterwerte
...
// Neue Funktion zum Ein- oder Ausblenden von Formularfeldern basierend auf der Auswahl
...
document.getElementById('plz').addEventListener('input', function() {
	...
	const validPlzPattern = /^\d{1,5}$/; //Das Feld darf nur aus Zahlen bestehen und maximal 5 Zeichen haben
